                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/usuario') }}">
                        ...
                        <div class="form-group row">
                            <label for="colaborador_id" class="col-md-4 col-form-label text-md-right">{{ __('colaborador_id') }}</label>

                            <div class="col-md-6">
                                <input id="colaborador_id" type="text" class="form-control @error('colaborador_id') is-invalid @enderror" name="colaborador_id" value="{{ old('colaborador_id') }}" required autocomplete="colaborador_id" autofocus>
